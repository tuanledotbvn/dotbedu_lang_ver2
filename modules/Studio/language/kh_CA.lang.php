...
$mod_strings=array (
  ...
  'LBL_SP_WELCOME' => 'Welcome to Studio for Dotb Portal. You can either choose to edit modules here or sync to a portal instance.<br> Please choose from the list below.',
  'LBL_STAGING_AREA' => 'Staging Area (drag and drop items here)',
  'LBL_SW_DOTBPORTAL' => 'Dotb Portal',
  ...
  'LBL_SYNCP_WELCOME' => 'Please enter the url to the portal instance you wish to update then press the Go button.<br> This will bring up a prompt for your user name and password.<br> Please enter your EMS user name and password and press the Begin Sync button.',
