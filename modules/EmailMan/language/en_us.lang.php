...
$mod_strings=array (
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Dotb Mail Client:</b> Send emails using the email client in the Dotb application.<br>This option is only available if your administrator has configured your email settings to allow it. Please contact your administrator if you have any questions.<br><b>External Mail Client:</b> Send email using an email client outside of the Dotb application, such as Microsoft Outlook.',
