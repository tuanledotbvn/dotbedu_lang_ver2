...
$mod_strings=array (
  ...
  'ERROR_FLAVOR_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Dotb: %s',
  ...
  'ERROR_VERSION_INCOMPATIBLE' => 'The upgrade package is not compatible with this version of Dotb: %s',
  'ERR_CHECKSYS_PHP_INVALID_VER' => 'Your version of PHP is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported PHP Versions. Your version is ',
  ...
  'ERR_UW_FLAVOR' => 'DotBCRM System Flavor: ',
  'ERR_UW_FLAVOR_2' => 'Upgrade Flavor: ',
  'ERR_UW_LOG_FILE_UNWRITABLE' => './upgradeWizard.log could not be created/written to.  Please fix permissions on your DotBCRM directory.',
  ...
  'ERR_UW_MYSQL_VERSION' => 'DotBCRM requires MySQL version 4.1.2 or newer.  Found: ',
  ...
  'ERR_UW_OCI8_VERSION' => 'Your version of Oracle is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported Oracle Versions. Current version: ',
  ...
  'ERR_UW_VERSION' => 'DotBCRM System Version: ',
...
',
  ...
  'LBL_UW_COMMIT_ADD_TASK_OVERVIEW' => 'Please use whichever diff method is most familiar to you to merge these files.  Until this is complete, your DotBCRM installation will be in an uncertain state, and the upgrade incomplete.',
  ...
  'LBL_UW_CONTINUE_CONFIRMATION' => 'This new version of Dotb contains new license agreement.  Would you like to continue?',
  ...
  'LBL_UW_DORP_THE_OLD_SCHMEA' => 'Would you like Dotb to drop the depricated 451 Schema ?',
...
',
  ...
  'LBL_UW_START_DESC' => 'This wizard will assist you in upgrading this Dotb instance.',
  'LBL_UW_START_DESC2' => 'Note: We recommend that you backup the Dotb database and the system files (all of the files in the DotBCRM folder) before upgrading your production system. We highly recommend that you perform a test upgrade on a cloned instance of your production system first.',
