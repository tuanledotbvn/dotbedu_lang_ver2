...
$mod_strings=array (
  ...
  'ERROR_CALCULATED_MOBILE_FIELDS' => 'The following field(s) have calculated values which will not be re-calculated in real time in the DotBCRM Mobile Edit View:',
  'ERROR_CALCULATED_PORTAL_FIELDS' => 'The following field(s) have calculated values which will not be re-calculated in real time in the DotBCRM Portal Edit View:',
  ...
  'LBL_DASHLETLISTVIEW' => 'Dotb Dashlet ListView',
  'LBL_DASHLETSEARCH' => 'Dotb Dashlet Search',
  'LBL_DASHLETSEARCHVIEW' => 'Dotb Dashlet Search',
  'LBL_DATA_TYPE' => 'Type',
  'LBL_DEFAULT' => 'Default',
  ...
  'LBL_DOTBPORTAL' => 'Dotb Portal Editor',
  'LBL_DOTB_BIN_STAGE' => 'Dotb Bin (click items to add to staging area)',
  'LBL_DOTB_FIELDS_STAGE' => 'Dotb Fields (click items to add to staging area)',
  'LBL_DOTB_PORTAL' => 'Dotb Portal Editor',
  ...
  'LBL_PORTAL' => 'Portal',
  'LBL_PORTALSITE' => 'Dotb Portal URL: ',
  ...
  'LBL_PORTAL_ROLE_DESC' => 'Do not delete this role. Customer Self-Service Portal Role is a system-generated role created during the Dotb Portal activation process. Use Access controls within this Role to enable and/or disable Bugs, Cases or Knowledge Base modules in Dotb Portal. Do not modify any other access controls for this role to avoid unknown and unpredictable system behavior. In case of accidental deletion of this role, recreate it by disabling and enabling Dotb Portal.',
  ...
  'LBL_POWERED_BY_DOTB' => 'Powered By DotB.vn',
  'LBL_PRIORITY' => 'Priority:',
  'LBL_PUBLISHED' => 'Published',
  'LBL_PUBLISHING' => 'Publishing ...',
  'LBL_QUESTION_DASHLET' => 'Select a dashlet layout to edit.',
  'LBL_QUESTION_DOTB_PORTAL' => 'Select a Dotb Portal layout to edit.',
  ...
  'LBL_SP_PREVIEW' => 'Here is a preview of what the Dotb Portal will look like using the style sheet.',
  'LBL_SP_UPLOADED' => 'Uploaded',
  'LBL_SP_UPLOADSTYLE' => 'Select a style sheet to upload from your computer.<br> The style sheet will be implemented in the Dotb Portal the next time you perform a sync.',
  ...
  'LBL_VIEW' => 'View',
  'LBL_VIEW_DOTB_BIN' => 'View Dotb Bin',
  'LBL_VIEW_DOTB_FIELDS' => 'View Dotb Fields',
  ...
  array (
    ...
    array (
      ...
      'afterSave' => 'Your new package should contain at least one module. You can create one or more custom modules for the package.<br/><br/>Click <b>New Module</b> to create a custom module for this package.<br/><br/> After creating at least one module, you can publish or deploy the package to make it available for your instance and/or other users\' instances.<br/><br/> To deploy the package in one step within your Dotb instance, click <b>Deploy</b>.<br><br>Click <b>Publish</b> to save the package as a .zip file. After the .zip file is saved to your system, use the <b>Module Loader</b> to upload and install the package within your Dotb instance.  <br/><br/>You can distribute the file to other users to upload and install within their own Dotb instances.',
    ...
    'module' =>
    array (
      'somemodules' => 'Since the current package contains at least one module, you can <b>Deploy</b> the modules in the package within your Dotb instance or <b>Publish</b> the package to be installed in the current Dotb instance or another instance using the <b>Module Loader</b>.<br/><br/>To install the package directly within your Dotb instance, click <b>Deploy</b>.<br><br>To create a .zip file for the package that can be loaded and installed within the current Dotb instance and other instances using the <b>Module Loader</b>, click <b>Publish</b>.<br/><br/> You can build the modules for this package in stages, and publish or deploy when you are ready to do so. <br/><br/>After publishing or deploying a package, you can make changes to the package properties and customize the modules further.  Then re-publish or re-deploy the package to apply the changes.',
...
',
  ...
  array (
    ...
    'subPanelEditor' =>
    array (
      'modify' => 'All of the fields that can be displayed in the <b>Subpanel</b> appear here.<br><br>The <b>Default</b> column contains the fields that are displayed in the Subpanel.<br/><br/>The <b>Hidden</b> column contains fields that can be added to the Default column.<br/><br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.',
    ...
    'listViewEditor' =>
    array (
      'modify' => 'All of the fields that can be displayed in the <b>ListView</b> appear here.<br><br>The <b>Default</b> column contains the fields that are displayed in the ListView by default.<br/><br/>The <b>Available</b> column contains fields that a user can select in the Search to create a custom ListView. <br/><br/>The <b>Hidden</b> column contains fields that can be added to the Default or Available column.<br/><br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.',
      'savebtn' => 'Click <b>Save & Deploy</b> to save changes you made and to make them active within the module.',
    ...
    'popupListViewEditor' =>
    array (
      'modify' => 'All of the fields that can be displayed in the <b>ListView</b> appear here.<br><br>The <b>Default</b> column contains the fields that are displayed in the ListView by default.<br/><br/>The <b>Hidden</b> column contains fields that can be added to the Default or Available column.<br/><br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.',
      'savebtn' => 'Click <b>Save & Deploy</b> to save changes you made and to make them active within the module.',
      'historyBtn' => 'Click <b>View History</b> to view and restore a previously saved layout from the history.<br><br><b>Restore</b> within <b>View History</b> restores the field placement within previously saved layouts. To change field labels, click the Edit icon next to each field.',
      'historyRestoreDefaultLayout' => 'Click <b>Restore Default Layout</b> to restore a view to its original layout.<br><br><b>Restore Default Layout</b> only restores the field placement within the original layout. To change field labels, click the Edit icon next to each field.',
      'Hidden' => '<b>Hidden</b> fields not currently available for users to see in ListViews.',
    ...
    'layoutEditor' =>
    array (
      'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.<br/><br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/DotbLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.',
      ...
      'property' => 'Edit the <b>Label</b> displayed for this field.<br><br><b>Width</b> provide a width value in pixels for Lumia modules and as a percentage of the table width for backward compatible modules.',
    ),
    'fieldsEditor' =>
    array (
    ...
    array (
      ...
      'mbBtn' => 'Use <b>Module Builder</b> to create new modules.',
      'dotbPortalBtn' => 'Use <b>Dotb Portal Editor</b> to manage and customize the Dotb Portal.',
      ...
      'studioBCHelp_2' => ' hybrid module is module with Listview of lumia, DetailView, EditView, Subpanel of BWC',
      'moduleBtn' => 'Click to edit this module.',
      ...
      'portalBtn' => 'Customize the module <b>Layouts</b> that appear in the <b>Dotb Portal</b>.',
      ...
      'viewBtnDashlet' => 'Customize the module\'s <b>Dotb Dashlet</b>, including the Dotb Dashlet\'s ListView and Search.<br><br>The Dotb Dashlet will be available to add to the pages in the Home module.',
      ...
      'dashletHelp' => 'The <b>Dotb Dashlet</b> layouts that can be customized appear here.<br><br>The Dotb Dashlet will be available to add to the pages in the Home module.',
      'DashletListViewBtn' => 'The <b>Dotb Dashlet ListView</b> displays records based on the Dotb Dashlet search filters.',
      'DashletSearchViewBtn' => 'The <b>Dotb Dashlet Search</b> filters records for the Dotb Dashlet listview.',
      ...
      'PopupSearchViewBtn' => '<b>Popup Search</b> layout allows users to search for records to relate to a current record and appears above the popup listview in the same window. Legacy modules use this layout for popup searching while Lumia modules use the Search layoutâs configuration.',
      ...
      'portalHelp' => 'Manage and customize the <b>Dotb Portal</b>.',
      'SPUploadCSS' => 'Upload a <b>Style Sheet</b> for the Dotb Portal.',
      'SPSync' => '<b>Sync</b> customizations to the Dotb Portal instance.',
      'Layouts' => 'Customize the <b>Layouts</b> of the Dotb Portal modules.',
      'portalLayoutHelp' => 'The modules within the Dotb Portal appear in this area.<br><br>Select a module to edit the <b>Layouts</b>.',
    ...
    'portalSync' =>
    array (
      'default' => 'Enter the <b>Dotb Portal URL</b> of the portal instance to update, and click <b>Go</b>.<br><br>Then enter a valid EMS user name and password, and then click <b>Begin Sync</b>.<br><br>The customizations made to the Dotb Portal <b>Layouts</b>, along with the <b>Style Sheet</b> if one was uploaded, will be transferred to specified the portal instance.',
    ),
    'portalConfig' =>
    array (
      'default' => '',
    ...
    'portalStyle' =>
    array (
      'default' => 'You can customize the look of the Dotb Portal by using a style sheet.<br><br>Select a <b>Style Sheet</b> to upload.<br><br>The style sheet will be implemented in the Dotb Portal the next time a sync is performed.',
    ),
  ),
  'labelTypes' =>
  array (
