...
$mod_strings=array (
  ...
  'ERR_FOR_IDM_MODE_GMP_REQUIRED' => 'For authentication with OpenID Connect (OIDC) in IDM mode please install GMP PHP extension.',
...
If you are not setting up Inbound Email, please clear all fields in that section.',
  'ERR_INVALID_PASSWORD' => 'Please check your user name and password and try again.',
  ...
  'ERR_USER_IS_LOCKED_OUT' => 'This user is locked out of the Dotb application and cannot log in using his/her existing password.',
  ...
  'LBL_ASTERISK_CHANEL' => 'Chanel',
  'LBL_ASTERISK_CONTEXT' => 'Context',
  'LBL_ASTERISK_IP' => 'IP',
  'LBL_ASTERISK_PHONE_EXTENSION' => 'Phone extension',
  ...
  'LBL_DEFAULT_TEAM' => 'Default Center',
  'LBL_DEFAULT_TEAM_TEXT' => 'Center available to appear by default in records are those of which you are a member.',
  'LBL_DELETED' => 'Deleted',
  ...
  'LBL_EDITVIEW_PANEL1' => 'Voip User Configuration Panel',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Dotb Mail Client:</b> Send emails using the email client in the Dotb application.<br>This option is only available if the system email settings have been set up correctly by the Administrator.<br><b>External Mail Client:</b> Send email using an email client outside of the Dotb application, such as Microsoft Outlook.',
  ...
  'LBL_EXTERNAL_USER_CANT_LOGIN' => 'External auth only user is not allowed to login using Dotb credentials',
  ...
  'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email).  This type cannot login through the Dotb web interface.',
  ...
  'LBL_ICAL_PUB_URL_HELP' => 'Use this URL to subscribe to your Dotb calendar within iCal-supported applications. Dotb calendar events are viewable as read-only in external calendar applications and any edits to events (e.g. meetings, calls etc.) can only be made in Dotb.',
  'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_ADMIN_USER' => 'If certain fields are not editable, please login to your Settings to manage these fields',
  'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_REGULAR_USER' => 'If you wish to change certain fields that are not editable, please contact Administrator to notify these changes',
  ...
  'LBL_LIMIT_USER' => 'You have reached a limit for users. Are you want to view license information ?',
  ...
  'LBL_LOGIN_WELCOME_TO' => 'DotB EMS - Education Management System | All-In-One',
  ...
  'LBL_PICK_TZ_WELCOME' => 'Welcome to Dotb.',
  'LBL_PICTURE_FILE' => 'Avatar',
  'LBL_PLEASE_INPUT_USER_PASS' => 'Please enter your User Name and password.',
  'LBL_PLEASE_INPUT_USER_VERIFY_KEY' => 'Please enter your Username and Verify key!',
  'LBL_PORT' => 'Mail server port',
  'LBL_PORTAL_ONLY' => 'Portal Only',
  'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the Dotb web interface.',
  ...
  'LBL_PROVIDE_USERNAME_AND_EMAIL' => 'We can’t find a User Name and an Email Address that matches what you entered. Verify that your username and email address (for example, username@company.com).',
  ...
  'LBL_REASS_TEAM_TO' => 'Set Center to:',
  ...
  'LBL_REMINDER_TEXT' => 'Set a default for reminders for calls and meetings. Pop-up notifications appear for all invitees using Dotb. Email reminders are sent to all invitees.',
  'LBL_REMOVED_TABS' => 'Admin Remove Tabs',
  'LBL_REPORTS_TO' => 'Reports to',
  'LBL_REPORTS_TO_ID' => 'Reports to ID:',
  'LBL_REPORTS_TO_NAME' => 'Reports to',
  'LBL_REQUEST_SUBMIT' => 'We\'ve sent you an email with a link to finish resetting your password. Can\'t find the email? Try checking your spam folder.',
  ...
  'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the Dotb Plug-in for Microsoft&reg; Outlook&reg; and the Dotb Plug-in for Microsoft&reg; Word&reg;.',
  ...
  'LBL_TASKS' => 'Tasks',
  'LBL_TEAMS' => 'Center',
  'LBL_TEAM_MEMBERSHIP' => 'Team Parent',
  ...
  'LBL_TIMEZONE_TEXT' => 'Set the current time zone. <br/><br/>Please note: this setting is only used by legacy modules and Import/Export functions. Dotb 7 modules automatically use the browser time zone. To avoid time zone conflicts, please set the time zone to match your browser time zone.',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.dotb.vn/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Dotb Community to discuss topics of interest with each other and with DotBCRM Developers</td></tr>
  ...
  'LBL_WIZARD_FINISH11' => 'Visit Dotb',
  ...
  'LBL_WIZARD_FINISH17' => 'Tips from DotBCRM Support for performing common tasks and processes in Dotb ',
  'LBL_WIZARD_FINISH18' => 'Forums ',
  'LBL_WIZARD_FINISH19' => 'Forums dedicated to the Dotb Community to discuss topics of interest with each other and with DotBCRM Developers ',
  'LBL_WIZARD_FINISH2' => 'Start Using Dotb',
  ...
  'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use Dotb!',
  'LBL_WIZARD_LOCALE' => 'Your Locale',
  'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in Dotb.',
  'LBL_WIZARD_NEXT_BUTTON' => 'Next >',
  'LBL_WIZARD_PERSONALINFO' => 'Your Information',
  'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible to other EMS users.<br />Fields marked with <span class="required">*</span> are required.',
  ...
  'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using Dotb.',
  'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using Dotb.',
