...
Obtain a API Key and Secret from Google by registering your Dotb instance as a new application.
...
<li>Once the project has been created enable the Google Calendar API, Google Drive and Google Contacts API</li>
