...
$mod_strings=array (
  ...
  'ERR_FAILED' => 'Unexpected failure, please check PHP logs and dotbcrm.log',
...
<ul>
    ...
    <li>Adapter:
    <ul>
    <li><i>Default Queue</i> - This will use only Dotb\'s Database without any message queue.</li>
