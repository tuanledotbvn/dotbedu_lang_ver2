...
$mod_strings=array (
  ...
  'ERR_INVALID_RECIPIENTS' => 'There are one or more recipients with an invalid email address. Please correct this and try again.',
  ...
  'LBL_ATTACH_DOTB_DOC' => 'EMS Document',
...
You may apply a predefined template using the Template button or include one of your signatures using the Signature button. Use the Upload New button to add an attachment to the email.',
  ...
  'LBL_NOT_DOTB_FOLDER' => 'NOOP - not a Dotb Folder',
  ...
  'LBL_NO_RELATED_TO_WITH_TEMPLATE_SEND_ANYWAYS' => 'Your email contains variables that will be replaced using values from the Related To record. Please confirm that the Related To field is set correctly before sending.',
  ...
  'LBL_OF' => 'of',
  'LBL_OPEN_DRAFT_ALERT' => 'Email is a draft. Click <a href="javascript:void(0);" data-action="email-draft">"{{subject}}"</a>  to edit.',
  ...
  'LBL_TEST_EMAIL_BODY' => 'This email was sent in order to test the outgoing mail server information provided in the Dotb application.  A successful receipt of this email indicates that the outgoing mail server information provided is valid.',
  'LBL_TEST_EMAIL_SUBJECT' => 'Test Email from Dotb',
  ...
  'LBL_TOTAL_ATTACHMENT_MAX_SIZE' => 'Your total attachments exceed {0}. Please reduce the size or number of attachments.',
  'LBL_TO_ADDRS' => 'To',
  'LBL_TYPE' => 'Type:',
  'LBL_UNKNOWN' => 'Unknown',
  'LBL_UNREAD' => 'Unread',
  ...
  'NTC_DELETE_CONFIRMATION_FORMATTED' => 'Are you sure you want to delete the {0}? It will be removed for all users who have access to this email.',
  'NTC_DELETE_CONFIRMATION_MULTIPLE' => 'Are you sure you want to delete selected email(s)? They will be removed for all users who have access to them.',
