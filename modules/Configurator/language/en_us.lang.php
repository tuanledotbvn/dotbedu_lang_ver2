...
$mod_strings=array (
  ...
  'CURRENT_LOGO_HELP' => 'This logo is displayed in the left-hand corner of the footer of the Dotb application.',
  ...
  'DOTBPDF_ADVANCED_SETTINGS' => 'Advanced Settings',
  'DOTBPDF_BASIC_SETTINGS' => 'Document Properties',
  ...
  'LBL_LDAP_GROUP_NAME_DESC' => 'Example <em>cn=dotbcrm</em>',
  ...
  'LBL_LDAP_USER_FILTER_DESC' => 'Any additional filter params to apply when authenticating users e.g.<em>is_dotb_user=1 or (is_dotb_user=1)(is_sales=1)</em>',
  ...
  'LBL_MAILMERGE_DESC' => 'This flag should be checked only if you have the Dotb Plug-in for Microsoft&reg; Word&reg;.',
  ...
  'LBL_MOBILE_MOD_REPORTS_RESTRICTION' => '* The Reports module is only available for the DotBCRM and Dotb Mobile native clients',
  ...
  'LBL_PORTAL_ON_DESC' => 'Allows users to manage portal user information within contact records. Portal users can access Cases, Bugs, Knowledge Base articles and other data through the Dotb Portal application.',
  ...
  'LBL_SEARCH' => 'Search:',
  'LBL_SESSION_TIMEOUT_TOOLTIP' => 'The Portal Session Timeout is for legacy versions of Dotb Portal available in 6.5 and older.',
...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
  ...
  'LBL_WIZARD_LOCALE_DESC' => 'Specify how you would like data in Dotb to be displayed, based on your geographical location. The settings you provide here will be the default settings. Users will be able set their own preferences.',
  ...
  'LBL_WIZARD_SYSTEM_DESC' => 'Provide your organization\'s name and logo in order to brand your Dotb.',
  'LBL_WIZARD_SYSTEM_TITLE' => 'Branding',
  'LBL_WIZARD_TITLE' => 'Admin Wizard',
  'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to brand, localize and configure Dotb now. If you wish to configure Dotb later, click <b>Skip</b>.',
  ...
  'MAX_DASHLETS' => 'Maximum number of Dotb Dashlets on Homepage',
  ...
  'PDF_INSTRUCTIONS_ADD_FONT' => 'Fonts supported by DotbPDF :
<ul>
...
<br><br>
Adding a PDF font to DotBCRM requires to follow steps 1 and 2 of the TCPDF Fonts documentation available in the "DOCS" section of the <a href="http://www.tcpdf.org" target="_blank">TCPDF website</a>.
