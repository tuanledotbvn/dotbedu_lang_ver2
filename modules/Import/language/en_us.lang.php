...
$mod_strings=array (
  ...
  'LBL_IMPORT_MODULE_ERROR_LARGE_FILE_END' => 'Bytes. Change $dotb_config[\'upload_maxsize\'] in config.php',
  'LBL_IMPORT_MODULE_ERROR_NO_MOVE' => 'File was not successfully uploaded.    Check the file permissions in your Dotb installation cache directory.',
  ...
  'LBL_MIME_TYPE_ERROR_1' => 'The selected file does not appear to contain a delimited list. Please check the file type. We recommend comma-delimited files (.xlsx).',
  ...
  //custom
  'LBL_DEFAULT_DUP_CHECK' => 'Default.',
  'LBL_CUSTOM_DUP_CHECK' => 'Select fields to check duplicate.',
  'LBL_DEFAULT_DUP_CHECK_HELP' => 'Use this option to check duplicate records based on the default duplicate check rule of this module.',
  'LBL_CUSTOM_DUP_CHECK_HELP' => 'Use this option to manually select fields to check duplicate records.',
);