...
$app_list_strings = array(
    ...
    'record_type_default_key' => 'Contacts',
    'record_type_display' =>
        array(
            '' => '',
            'Contacts' => 'Student',
    ...
    'dom_email_link_type' => array('dotb' => 'Dotb Email Client',
    ...
    'lead_prefer_package_dom' => array(
        'DOTB1' => 'DOTB1 - 2,000 Students',
        'DOTB2' => 'DOTB1 - 5,000 Students',
        'DOTB3' => 'DOTB1 - 10,000 Students',
        'none' => 'Undefined',
...
$app_strings = array(
    ...
    'LBL_RECORD_BODY' => 'Overview', // Studio editing of record views
    'LBL_RECORD_SHOWMORE' => 'Others', // Studio editing of record views
    'LBL_FAVORITE' => 'Like', // Record view header panel element
    ...
    'LBL_COPYRIGHT' => 'Copyright © 2018-2023 DotB với tất cả quyền sở hữu.',
    'LBL_TRADEMARK' => 'DotB, DOTB SOFTWARE COMPANY LIMITED ' .
        'All other company and product names used or appearing in this product may be trademarks of the ' .
        'respective companies with which they are associated.',
    'LBL_TRADEMARK2' => 'DotB ®, Dotb Enterprise™ and Dotb™ are trademarks of DotB.',
    ...
    'LBL_VIEWINLINE' => 'View',
    'LBL_INFOINLINE' => 'Info',
    'LBL_POWERED_BY_DOTBCRM' => "Powered By DotB.vn",
    'LBL_PRINT' => "Print",
    'LBL_TOUR' => "Tour",
    ...
    'LBL_ROUTING_ACTIONS_DELETE_BEAN' => 'Delete Dotb Object',
    ...
    'LBL_EMAIL_ARCHIVE_TO_DOTB' => 'Import to Dotb',
    ...
    'LBL_EMAIL_ATTACHMENTS2' => 'From EMS Documents',
    ...
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'Dotb Folder names must be unique.',
    ...
    'LBL_EMAIL_IMPORT_EMAIL' => 'Import to Dotb',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'Create a Folder (remote or in Dotb)',
    'LBL_EMAIL_MENU_HELP_ARCHIVE' => 'Archive these email(s) to DotB',
    ...
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'Delete a Folder (remote or in Dotb)',
    ...
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Rename a Folder (remote or in Dotb)',
    ...
    'LBL_EMAIL_SPACER_LOCAL_FOLDER' => '[ Dotb Folders ]',
    ...
    'ERR_DISABLED_FOR_IDM_MODE' => "This option is disabled in DotB for IDM mode and available in Settings.",
    ...
    'ERR_POTENTIAL_SEGFAULT' => 'A potential Apache segmentation fault was detected.  Please notify your system administrator to confirm this problem and have her/him report it to DotB.',
    ...
    'ERR_NO_DB' => 'Could not connect to the database. Please refer to dotbcrm.log for details.',
    'ERR_DB_FAIL' => 'Database failure. Please refer to dotbcrm.log for details.',
    ...
    'ERR_DB_VERSION' => 'Dotb CRM {0} Files May Only Be Used With A Dotb CRM {1} Database.',
    ...
    // Default DotbApiException error messages
    ...
    'EXCEPTION_MAINTENANCE' => 'EMS is in maintenance mode. Only admins can login. Please contact your administrator for details.',
    ...
    // Default DotbApiException descriptions, used in the exceptions help endpoint
    ...
    'EXCEPTION_MAINTENANCE_DESC' => 'The instance of DotB that is serving the API is in maintenance mode. Access to the API is restricted to administrators only.',
    ...
    'EXCEPTION_SEARCH_RUNTIME_DESC' => 'A runtime exception occured in SearchEngine. See dotbcrm.log for more details.',
    ...
    'LBL_BROWSER_TITLE' => 'DotB - Commercial Open Source CRM',
    ...
    'LBL_REPORT_BUTTON_LABEL' => 'Report',
    ...
    // The following version of LBL_DOTB_COPYRIGHT is for (Grow Fast, Scale Up or On-premise).

    'LBL_DOTB_COPYRIGHT_SUB' =>
        'DotB &copy; 2018-2023 <a href="http://www.dotb.vn" target="_blank" class="copyRightLink">DotB.</a> ' .
        'All Rights Reserved.<br />DotB, DOTB SOFTWARE COMPANY LIMITED. ' .
        'All other company and product names used or appearing in this product may be trademarks of the ' .
        'respective companies with which they are associated.',
    ...
    'LBL_JOB_NOTIFICATION_OPPS_WITH_RLIS_SUBJECT' => 'Revenue Line Items Are Now Enabled in Your Dotb Instance',
    'LBL_JOB_NOTIFICATION_OPPS_WITH_RLIS_BODY' => 'Revenue Line Items are now enabled in your Dotb instance, and all existing Opportunity data has been processed. Your instance is now ready to be used with Revenue Line Items. For more information about the changes which have been made, please refer to the {{doc_url}}.

        Sincerely, DotB',

    'LBL_JOB_NOTIFICATION_OPP_FORECAST_SYNC_SUBJECT' => 'Forecasts Module is Now Ready for Use With Opportunities in Your Dotb Instance',
    'LBL_JOB_NOTIFICATION_OPP_FORECAST_SYNC_BODY' => 'The Forecasts module in your Dotb instance is now available for use with opportunities. All previous Revenue Line Item forecast commit data has been removed, and the instance is ready for forecasts to be created and committed with opportunities. For more information about the changes which have been made, please refer to the {{doc_url}}.

        Sincerely, DotB',

    'LBL_JOB_NOTIFICATION_RLI_NOTE_SUBJECT' => 'Revenue Line Items Are Now Disabled in Your Dotb Instance',
    'LBL_JOB_NOTIFICATION_RLI_NOTE_BODY' => 'Revenue line Items are now disabled in your Dotb instance, and all existing Revenue Line Item data has been processed. Your instance is now ready to be used with Opportunities. For more information about the changes which have been made, please refer to the {{doc_url}}.
    ...
    'TPL_AUDIT_LOG_TITLE' => 'Change Log for {{{name}}}',
    ...
    'NTC_SUPPORT_DOTBCRM' => 'Support the DotB open source project with a donation through PayPal - it\'s fast, free and secure!',
    'NTC_TIME_FORMAT' => '(24:00)',
    'NTC_WELCOME' => 'Welcome',
    'NTC_YEAR_FORMAT' => '(yyyy)',
    'LOGIN_LOGO_ERROR' => 'Please replace the DotB logos.',
    'FATAL_LICENSE_ALTERED' => "Your license has been altered since the last time it was validated.",
    'ERROR_FULLY_EXPIRED' => "Your company's license for DotB has expired for more than 7 days and needs to be brought up to date. Only admins may login.",
    'ERROR_LICENSE_EXPIRED' => "Your company's license for DotB needs to be updated. Only admins may login.",
    'WARN_LICENSE_EXPIRED' => "Your company's license for DotB will expire soon.",
    'ERROR_LICENSE_VALIDATION' => "Your company's license for DotB needs to be validated. Only admins may login.",
    'WARN_LICENSE_VALIDATION' => "Your company's license for DotB needs to be validated soon.",
    ...
    'ERROR_PA_UNSUPPORTED_FILE' => 'Import failed. Please check your dotb log for more details.',
    ...
    'LBL_POSIPLE_DUP' => 'Possible Duplicated',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_TASKS_MSG' => "Click OK to view this Tasks or click Cancel to dismiss this message.",
    ...
    /* MyDotb Framework (for Home and Dashboard) */
    'LBL_DASHLET' => 'Dashlet',
    ...
    // MyDotb status strings
    'LBL_CREATING_NEW_PAGE' => 'Creating New Page ...',
    'LBL_NEW_PAGE_FEEDBACK' => 'You have created a new page. You may add new content with the Add Dotb Dashlets menu option.',
    ...
    'LBL_MAX_DASHLETS_REACHED' => 'You have reached the maximum number of Dotb Dashlets your adminstrator has set. Please remove a Dotb Dashlet to add more.',
    'LBL_ADDING_DASHLET' => 'Adding Dotb Dashlet ...',
    'LBL_ADDED_DASHLET' => 'Dotb Dashlet Added',
    'LBL_REMOVE_DASHLET_CONFIRM' => 'Are you sure you want to remove the Dotb Dashlet?',
    'LBL_REMOVE_DASHLET_ROW_CONFIRM' => 'Are you sure you want to remove the row?',
    'LBL_REMOVING_DASHLET' => 'Removing Dotb Dashlet ...',
    'LBL_REMOVED_DASHLET' => 'Dotb Dashlet Removed',
    ...
    'LBL_DASHLET_RECENT_TWEETS_DOTBCRM_NAME' => 'Recent Tweets - @{{twitter}}',
    ...
    'LBL_LEARNING_RESOURCES_DOTB_UNIVERSITY_LINK' => 'Dotb - Become an expert',
    ...
    'LBL_RELOAD_PAGE' => 'Please <a href="javascript: window.location.reload()">reload the window</a> to use this Dotb Dashlet.',
    ...
    'LBL_PLUGIN_OUTLOOK_NAME' => 'Dotb Plug-in for Outlook',
    'LBL_PLUGIN_OUTLOOK_DESC' => 'Integrate Dotb e-mail and calendar information with Microsoft Outlook.',
    'LBL_PLUGIN_WORD_NAME' => 'Dotb Plug-in for Word',
    'LBL_PLUGIN_WORD_DESC' => 'Automatically populate information from DotB into form letters, direct mail and other Microsoft documents.',
    'LBL_PLUGIN_EXCEL_NAME' => 'Dotb Plug-in for Excel',
    'LBL_PLUGIN_EXCEL_DESC' => 'Integrate Dotb with spreadsheets for better analysis of key metrics.',
    'LBL_PLUGINS_TITLE' => 'Dotb Plug-ins for Microsoft Office<sup>TM</sup>',
    'LBL_PLUGINS_DESC' => 'Read about the plug-in features within the <a href="https://www.dotb.vn">Plug-ins Documentation</a>.',

    'LBL_PLUGINS_LOTUS_TITLE' => 'Dotb Plug-ins for Lotus Notes<sup>TM</sup>',
    'LBL_PLUGIN_LOTUS_NAME' => 'Dotb Plug-in For Lotus Notes',
    'LBL_PLUGIN_LOTUS_DESC' => 'Integrate Dotb with Lotus Notes.',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => 'Welcome to Dotb Portal 5.1.0',
    'LBL_PORTAL_WELCOME_INFO' => 'Dotb Portal is a framework which provides real-time view of cases, bugs & newsletters etc to customers. This is an external facing interface to Dotb that can be deployed within any website.  Stay tuned for more customer self service features like Project Management and Forums in our future releases.',
    'LBL_LIST' => 'List',
    ...
    'ERR_SUHOSIN' => 'Upload stream is blocked by Suhosin, please add &quot;upload&quot; to suhosin.executor.include.whitelist (See dotbcrm.log for more information)',
    ...
    //DotbApiExceptionNotAuthorized language string
    'DOTB_API_EXCEPTION_NOT_AUTHORIZED' => 'Not allowed to edit field {0} in module: {1}',
    'DOTB_API_EXCEPTION_RECORD_NOT_AUTHORIZED' => 'Not allowed to perform action "{0}" on this record',
    ...
    'LBL_TOUR_WELCOME' => 'What\'s New in Dotb',
    'LBL_TOUR_WATCH' => 'Watch What\'s New in Dotb',
    ...
    'LBL_TOUR_CALENDAR_URL_1' => 'Do you share your DotB calendar with 3rd party applications, such as Microsoft Outlook or Exchange? If so, you have a new URL. This new, more secure URL includes a personal key which will prevent unauthorized publishing of your calendar.',
    ...
    'LBL_TOUR_INTRO' => '<h4>Welcome to DOTB-EMS</h4> We\'d like to walk you through some of the features.  Use the < and > arrows on the bottom of the screen to take a tour.<ul class="resource-list"><li class="resource"><a href="https://help.dotb.vn" target="_blank"><span class="label label-module label-module-md pull-left blue"><i class="fa fa-2x fa-magic"></i></span></a><div class="resource-info"><a href="https://help.dotb.vn/" target="_blank">User guide</a><p class="details">View the user guide to understand the system faster.</p></div></li><li class="resource"><a href="https://www.youtube.com/@dotb8300" target="_blank"><span class="label label-module label-module-md pull-left green"><i class="fa fa-2x fa-play"></i></span></a><div class="resource-info"><a href="https://www.youtube.com/@dotb8300" target="_blank">Find out more about DotB</a><p class="details">A powerful library of eLearning, live and virtual classroom training and video tutorials.</p></div></li><li class="resource"><a href="http://support.dotb.vn/" target="_blank"><span class="label label-module label-module-md pull-left red"><i class="fa fa-2x fa-question-circle"></i></span></a><div class="resource-info"><a href="http://support.dotb.vn/" target="_blank">Get Support</a><p class="details">You\'re looking to get help or want to report a bug or give feedback. Your thoughts are valuable in helping improve our products.</p></div></li></ul>',
    ...
    'ERR_MOBILE_SSO_NOT_CONFIGURED' => 'SSO login is unavailable. Ensure the instance is on Dotb 7.5 or greater and configured for SSO.',
    ...
    'LBL_MOBILE_TUTORIAL_HOME_MENU_DESKTOP' => 'Open Dotb in the web browser.',
    ...
    'LBL_PORTAL_LOGIN_FORGOTPASSWORD' => 'Please contact your Dotb Admin to reset your password.',
    ...
    'LBL_SETUP_COMPLETE_INFO' => 'Start using EMS!',
    ...
    'LBL_PLEASE_INPUT_USER_PASS' => 'Please input Username and Password!',
    //User wizard links
    'LBL_WIZ_DOTB_TRAINING' => 'Training',
    ...
    'ERR_HTTP_400_TEXT_LINE2' => 'Please contact your EMS Administrator for more details.',
    ...
    'ERR_HTTP_404_TEXT_LINE2' => 'Please try again. If the error persists, please contact your EMS Administrator.',
    ...
    'ERR_HTTP_500_TEXT_LINE2' => 'Please try again. If the error persists, please contact your EMS Administrator.',
    ...
    'ERR_HTTP_502_TEXT_LINE2' => 'Please try again. If the error persists, please contact your EMS Administrator.',
    ...
    'ERR_HTTP_503_TEXT_LINE2' => 'Please try again later. If the error persists, please contact your EMS Administrator.',
    ...
    'LBL_AUDIT_SUBJECT_DOTB-WORKFLOW' => 'Dotb Workflow',
    ...
    'LBL_PASSWORD_REQUEST_ERROR' => 'There was a problem retrieving your username and email.',
    ...
    'LBL_HELP_DUPLICATE' => 'Dotb has detected that the record you are trying to create may already exist.
    ...
    // shortcut keys help
    'LBL_SHORTCUT_KEYS_HELP_ABOUT' => 'DotB enables power users to quickly perform certain tasks with keyboard shortcuts to increase productivity. The tables on the right describe available shortcuts along with the keys and the actions they perform.',
    ...
    'LBL_ENABLE_JAVASCRIPT' => 'Dotb 7 requires javascript. Please enable Javascript in your browser to use Dotb 7.',
    ...
    'LBL_HELP' => 'Help',
    'LBL_PHONE_BOX_NUMBER'=>'Phone keyboard',

    'LBL_DASHLET_STATS'=>'Stat Report',
    'LBL_DASHLET_STATS_DESC'=>'Display stat from your report'
);
...
$app_list_strings['moduleList']['Dotb_Favorites'] = 'Favorites';
$app_list_strings['moduleListSingular']['Dotb_Favorites'] = 'Favorite';
...
$app_strings['LBL_PREVIEW'] = 'Preview';
...
$app_strings['LBL_CONNECTION_ERROR'] = 'Connection Error. Please, Try again!';
$app_strings['LBL_VERIFY_KEY_FAIL'] = 'Verify key invalid!';
$app_strings['LBL_TRANSLATE_LANGUAGES'] = 'Translate languages';
$app_strings['LBL_CALLCENTER_BUTTON'] = 'Call Center';
$app_strings['LBL_DIALNUMBER'] = 'Dial';
$app_strings['LBL_PHONE_NUMBER'] = 'Phone number';
$app_strings['LBL_CALL_UNDER_40S_SYNC'] = 'Make a dial call in less than 40 seconds';
$app_strings['LBL_CAN_NOT_DIAL_CALLCENTER'] = 'Cannot dial a phone number';
$app_strings['LBL_USERNAME'] = 'User name';
$app_strings['LBL_PASSWORD'] = 'Password';
$app_strings['LBL_LOGIN'] = 'Login';
$app_strings['LBL_OUTBOUND'] = 'Outbound';
$app_strings['LBL_INBOUND'] = 'Inbound';
$app_strings['LBL_WAITING'] = 'waiting';
$app_strings['LBL_RINGING'] = 'ringing';
$app_strings['LBL_CONNECTED'] = 'connected';
$app_strings['LBL_BYE'] = 'hangup';
$app_strings['LBL_CANCEL'] = 'cancel';
$app_strings['LBL_REJECT'] = 'reject/busy';
$app_strings['LBL_SAVE_CALL_LOG'] = 'Save';
$app_strings['LBL_LICENSE_INFO'] = 'License info';
$app_strings['LBL_TICKET'] = 'Ticket';

$app_strings['LBL_FWP_EMAIL'] = '(Required) Email';
$app_strings['LBL_FWP_USER_NAME'] = '(Required) User name';
$app_strings['LBL_FWP_REQUEST'] = 'Request Password';
$app_strings['LBL_FWP_LOGIN'] = 'Return to Login';
$app_strings['LBL_POWERED_BY'] = 'Powered by';

$app_strings['LBL_DISPLAY_STATS'] = 'Select the stats to display';
$app_strings['LBL_DISPLAY_TYPE'] = 'View as';