...
$mod_strings=array (
    ...
    'ERROR_FLAVOR_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Dotb: ',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Dotb: ',
    'ERROR_VERSION_MISSING' => 'Manifest file must specify an acceptable version of Dotb',
    'ERR_CANNOT_CREATE_RESTORE_FILE' => 'Error: Could not create restore file',
    'ERR_CREDENTIALS_MISSING' => 'Your dotb.vn credentials are missing.',
    'ERR_DELETE_RECORD' => 'A record number must be specified to delete the account.',
    'ERR_DOTB_DEPOT_DOWN' => 'The system is unable to connect to Dotb Exchange for browsing and downloading packages.',
    ...
    'Groups' => 'Group',
    'HDR_LOGIN_PANEL' => 'Please enter your dotb.vn credentials.',
    'HEARTBEAT_MESSAGE' => '<BR>The Dotb Updates mechanism allows your server to check to see if an update for your version of Dotb is available.',
    'Holidays' => 'Holiday',
    'Import_1' => 'ImportMap',
    ...
    'LBL_ADMIN_DOTB_SERVER' => 'Admin User Name:',
    'LBL_ADMIN_WIZARD' => 'Easily setup your DotBCRM system',
    ...
    'LBL_BACKUP' => 'Schedule backups to the Dotb Online Data Vault.  Activate a system restoration from backup.',
    'LBL_BACKUPS' => 'Backup Dotb files',
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by Dotb',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the Dotb application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your Dotb application files in a .zip file, enter the following information:',
    ...
    'LBL_CONFIGURE_SNIP_DESC' => 'Enable/disable the Dotb Email Archiving Service',
    ...
    'LBL_CONFIGURE_UPDATER' => 'Configure Dotb Updates',
    'LBL_CONFIG_CALL_CENTER' => 'Config Call Center',
    'LBL_CONFIG_CHECK' => 'Config Check',
    'LBL_CONFIG_FTS' => 'Configure Full Text Search Engine',
    'LBL_CONFIG_ICON_MODULE' => 'Config Module Icon',
    ...
    'LBL_CONNECTOR_SETTINGS' => 'LMS Connectors',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the Dotb Server.
    ...
    'LBL_CUSTOM_API_PLATFORMS_HELP' => 'Standard platforms cannot be modified. Platforms loaded via a module loadable package must be removed by uninstalling the appropriate package.',
    'LBL_DAYS' => 'day(s)',
    ...
    'LBL_DENY' => 'Deny',
    'LBL_DEPTID' => 'DeptID',
    'LBL_DIAGNOSTICS_ERROR_DOTBLOG' => 'Could not copy dotbcrm.log to {0}<br>',
    ...
    'LBL_DIAGNOSTICS_VARDEFS_VERSIONS' => '<P>Dotb version:  {0} / Dotb DB version:  {1} / Dotb flavor:  {2}',
    ...
    'LBL_DIAGNOSTIC_DOTBLOG' => 'DotBCRM Log File',
    ...
    'LBL_DIAGNOSTIC_GETDOTBLOG' => 'Getting dotbcrm.log',
    ...
    'LBL_DOCUMENTATION' => 'View EMS Documentation for administrators and end-users',
    'LBL_DOCUMENTATION_TITLE' => 'Online Documentation',
    'LBL_DONE' => 'Done',
    'LBL_DOTBCRM_HELP' => 'DotBCRM Help',
    'LBL_DOTBPDF_SETTINGS' => 'PDF',
    'LBL_DOTBPDF_SETTINGS_DESC' => 'Manage settings for generated PDF files',
    'LBL_DOTBPORTAL' => 'Dotb Portal',
    'LBL_DOTBPORTAL_DESC' => 'Manage the Dotb Portal',
    'LBL_DOTB_NETWORK_DESC' => 'Connect to the various DotBCRM services where you can access the DotBCRM forums and Dotb Wiki, search FAQs (Frequently Asked Questions), download the latest Dotb version, file and research reported bugs and request new features and more.',
    'LBL_DOTB_NETWORK_TITLE' => 'Dotb Connect',
    'LBL_DOTB_SCHEDULER' => 'Set up scheduled events',
    'LBL_DOTB_SCHEDULER_TITLE' => 'Scheduler',
    'LBL_DOTB_SERVER_URL' => 'Server URL:',
    'LBL_DOTB_SERVER_URL_DESC' => '- The URL of the server this client will connect to (e.g., http://localhost/dotbserver).',
    'LBL_DOTB_UPDATE' => 'Check for the latest Dotb version',
    'LBL_DOTB_UPDATE_TITLE' => 'Dotb Updates',
    ...
    'LBL_DRI_CUSTOMER_JOURNEY_CONFIGURE_MODULES_LINK_NAME' => 'Customer Insight Configure',
    'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_DESC' => 'Configure the Customer Insight Plugin',
    'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_LINK_DESC' => 'Configure license and user access',
    'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_LINK_NAME' => 'Configure License & Users',
    'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_TITLE' => 'Customer Insight',
    'LBL_DRI_CUSTOMER_JOURNEY_TEMPLATES_LINK_DESC' => 'Manage Templates',
    'LBL_DRI_CUSTOMER_JOURNEY_TEMPLATES_LINK_NAME' => 'Customer Insight Templates',
    ...
    'LBL_EAPM_SETTINGS_DESC' => 'Select external applications for which users can provide their account information in order to access from within Dotb.',
    ...
    'LBL_EXPORT_CUSTOM_FIELDS' => 'Export custom field definitions to a .dotb file',
    ...
    'LBL_FTE_UT_ACTION_DESCRIPTION' => 'Use this section to add any custom configuration you want to this particular DotBCRM instance',
    'LBL_FTE_UT_ACTION_NAME' => 'Custom configuration',
    'LBL_FTE_UT_SECTION_DESCRIPTION' => 'Administrate the Dotb demo environment settings.',
    'LBL_FTE_UT_SECTION_HEADER' => 'Configurator 3rd',
    ...
    'LBL_FTS_CONN_UNKNOWN_FAILURE' => 'An error occured connecting to the specified full text seach server. Check dotbcrm.log for more details.',
    ...
    2) Click Test to make sure Dotb can connect to the search engine.<br>
    ...
    'LBL_FTS_TYPE_HELP' => 'Select the engine to use for full text searching. The system detects the engines that are supported and displays them within this list. Dotb includes built-in support for the elasticsearch engine.',
    ...
    To enable modules for global searches in DotBCRM Mobile and Dotb Portal, please use the <a href="index.php?module=Administration&action=UnifiedSearchSettings">Legacy Global Search Configuration</a>. <br>
    For more information, refer to the <a href="http://www.dotb.vn/crm/product_doc.php?edition=ENT&version=7.7.0.0beta4&lang=en_us&module=FullTextSearch">Search</a> documentation.',
    ...
    'LBL_IFRAME' => 'My Sites',
    'LBL_IMPORT_CUSTOM_FIELDS' => 'Import custom field definitions from a .dotb file',
    ...
    'LBL_IMPORT_CUSTOM_FIELDS_STRUCT' => ' Custom Field Structure (DotbCustomFieldStruct.sug)',
    ...
    'LBL_LDAP_ADMIN_USER_DESC' => 'Used to search for the EMS user. [May need to be fully qualified] It will bind anonymously if not provided.',
    ...
    'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist one will be created in Dotb.',
    ...
    'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=dotbcrm',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the Dotb Password Management feature settings will apply.',
    ...
    'LBL_LINK_AUTO_SET_PRESET_IMPORT' => 'Set default  pre-set mapping import',
    'LBL_LINK_DESCRIPTION' => 'WARNING:  This operation will overwrite the data in this Dotb instance including, but not limited to updating the close date for all opportunities to the current quarter.',
    'LBL_LINK_NAME' => 'Reset Demo Data',
    ...
    'LBL_LIST_VIEW' => 'List',
    'LBL_LNK_DUPLICATION_DETECTION' => 'Duplication detection',
    ...
    'LBL_LOGIN_DOTB_SERVER' => 'End User Name:',
    'LBL_LOGIN_DOTB_SERVER_DESC' => '- The User Name of the person who will operate this offline client',
    'LBL_MAILBOX_DESC' => 'Configure the IMAP account Dotb uses to receive system emails (i.e. group inboxes including automatic case creation and campaign bounce handling).',
    ...
    'LBL_MANUAL_VALIDATION2' => 'Then save the file (dotbkey.lic) on your local file system.',
    'LBL_MANUAL_VALIDATION3' => 'Step 2: Transfer the dotbkey.lic file to a system where you can access the internet with a web browser.   <br<br>Go to {{manualValidation3Url}} and submit the dotbkey.lic file.  <br><br>The license validation web site will perform the validation immediately and return you the validation key file (dotbvalidationkey.lic) if the validation is successful.  Your browser should prompt you to save the file.  ',
    'LBL_MANUAL_VALIDATION4' => 'Step 3:  Transfer the validation key file (dotbvalidationkey.lic) back to the DotBCRM system.  Import the validation key using this form below: ',
    ...
    'LBL_MASSAGE_MASS_EMAIL_DESC' => 'DotBCRM 3.5.1+ requires an update to the Mass Email data.  Click "Begin Update" to continue.',
    'LBL_MASS_EMAIL_CONFIG_DESC' => 'Configure the email account Dotb uses to send system emails (e.g. notifications, campaigns, scheduled reports etc.), email options for the organization and email security.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing Dotb Dashlet ',
    ...
    'LBL_MI_UN_DASHLETS' => 'Uninstalling Dotb Dashlet ',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of Dotb',
    ...
    'LBL_MODULE_LOADER' => 'Add or remove Dotb modules, themes, language packs and other extensions',
    ...
    'LBL_OFFLINE_CLIENT' => 'View Offline Clients that are connected to this Dotb system',
    ...
    'LBL_PASSWORD_DOTB_SERVER' => 'Admin Password:',
    'LBL_PASSWORD_DOTB_SERVER_DESC' => '- An Admin user name and password on the server',
    ...
    'LBL_PLUGINS' => 'Get plug-ins and other Dotb extensions.',
    ...
    'LBL_PMSE_ADMIN_TITLE_MODULE' => 'Workflow',
    ...
    'LBL_PRICE_LIST_TITLE' => 'Product and Course Fee',
    ...
    'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as Dotb updates.',
    'LBL_PROXY_PASSWORD' => 'Password',
    'LBL_PROXY_PORT' => 'Port',
    'LBL_PROXY_TITLE' => 'Proxy Settings',
    'LBL_PROXY_USERNAME' => 'User Name',
    'LBL_PUBLIC_KEY' => 'Public Key',
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear Dotb Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing Dotb Dashlet files from cache...done',
    'LBL_QR_CLEARDOTBFEEDCACHE' => 'Clearing Dotb Feed Cache...done',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds Cache, Extensions, Vardefs, Dotb Dashlets etc.',
