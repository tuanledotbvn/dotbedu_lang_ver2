...
$mod_strings=array (
  'ERR_CREATE_EMPLOYEE_FOR_IDM_MODE' => 'The employee can be created only in <a href="{0}" target="_blank">Cloud console</a> for IDM mode.',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Dotb Mail Client:</b> Send emails using the email client in the Dotb application.<br><b>External Mail Client:</b> Send email using an email client outside of the Dotb application, such as Microsoft Outlook.',
